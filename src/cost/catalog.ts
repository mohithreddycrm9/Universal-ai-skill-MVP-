...
export const COST_CATALOG = {
  ...
  skillspector_llm: {
    ...
    service: "SkillSpector semantic / LLM analyzers",
    pricingModel: "freemium" as const,
    freeTier: true,
    estimatedCost: "unknown",
    requiresApproval: true,
    purpose: "Optional SkillSpector LLM pass (SKILLSPECTOR_PROVIDER). Static scan is free.",
    freeAlternative: "skillspector with useLlm:false (--no-llm)",
  },
